...
export class PurchaseSettingsComponent implements OnInit {
 ...
 //form
 VendorQuotTermsAddForm: FormGroup;
 VendorQuotTermsEditForm: FormGroup;
 vin;
 ...
 createForm(){
    ...
    this.VendorQuotTermsAddForm = this.formBuilder.group({ 
      quotTermsName: ['', Validators.compose([ Validators.required ])],
      quotTerms: ['', Validators.compose([ Validators.required ])] 
    });
    this.VendorQuotTermsEditForm= this.formBuilder.group({ 
      quotTermsName: ['', Validators.compose([ Validators.required ])],
      quotTerms: ['', Validators.compose([ Validators.required ])]  
    });
